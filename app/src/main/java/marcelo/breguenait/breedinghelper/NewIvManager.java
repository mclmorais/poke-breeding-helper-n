...
public class NewIvManager {
    ...
    private boolean checkCompatibility(PokemonInfo firstPokemon, PokemonInfo secondPokemon) {
        ...
        if(firstPokemon.gender == Gender.MALE && secondPokemon.gender == Gender.FEMALE) {
            ...
            boolean maleCompatible = checkEggGroupCompatiblity(firstPokemon);
            ...
            boolean maleCompatible = checkEggGroupCompatiblity(secondPokemon);
     ...
     * @return True if it is compatible, false if it's not
     */
    private boolean checkEggGroupCompatiblity(PokemonInfo potential) {
        if(goalPokemon == null) throw new NullPointerException();
    ...
    private void fillCombinations() {
        ...
        * The total number of combinations is C(6,5) = 6.*/
        ...
        destinyKnotCombinations.put(0,Integer.parseInt("111101",2));
        destinyKnotCombinations.put(0,Integer.parseInt("111011",2));
        destinyKnotCombinations.put(0,Integer.parseInt("110111",2));
        destinyKnotCombinations.put(0,Integer.parseInt("101111",2));
        destinyKnotCombinations.put(0,Integer.parseInt("011111",2));
